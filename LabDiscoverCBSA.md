...
Il devrait notamment utiliser les outils suivants :
- `scan_program` pour scanner les programmes
- `extract_variables` pour extraire les variables
- `create_database` pour créer la base de données
- `update_agents` pour mettre à jour AGENTS.md
